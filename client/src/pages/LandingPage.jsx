...
export default function LandingPage() {
  ...
  const [stats, setStats] = useState({ totalUsers: 0, totalConversations: 0, totalServers: 0 })
    ...
    <div style={{
        ...
        <div className="l-hero-content">
          ...
          <Reveal delay={320}>
              ...
              <div className="l-metric">
                <div className="l-metric-val"><Counter target={stats.totalServers || 0} /></div>
                <div className="l-metric-label">Servers created</div>
              </div>
              <div className="l-metric">
                <div className="l-metric-val"><Counter target={stats.totalUsers || 0} /></div>
          ...
          <Reveal delay={400}>
            <div className="social-proof">
              ...
              <div className="social-proof-text">Trusted by <strong>{(stats.totalUsers || 0).toLocaleString()}+</strong> server creators</div>
            </div>
          </Reveal>
        </div>
      </section>
      ...
      <footer className="l-footer">
        ...
        <div style={{ fontSize: 13, color: colors.muted }}>
          Developed by <a href="https://github.com/subhanplays" target="_blank" rel="noopener noreferrer" style={{ color: colors.accent, textDecoration: 'none', fontWeight: 600 }}>Subhanplays</a>
        </div>
        <div className="l-footer-right">
          <a href="https://www.youtube.com/@Notsubhanplays" target="_blank" rel="noopener noreferrer" style={{ color: colors.muted, fontSize: 13, textDecoration: 'none', display: 'flex', alignItems: 'center', gap: 4, transition: 'color 0.2s' }}
          ...
          <a href="https://www.instagram.com/subhanplays_yt/" target="_blank" rel="noopener noreferrer" style={{ color: colors.muted, fontSize: 13, textDecoration: 'none', display: 'flex', alignItems: 'center', gap: 4, transition: 'color 0.2s' }}
            onMouseEnter={e => e.currentTarget.style.color = colors.text}
            onMouseLeave={e => e.currentTarget.style.color = colors.muted}
          >
          ...
          <a href="https://github.com/subhanplays" target="_blank" rel="noopener noreferrer" style={{ color: colors.muted, fontSize: 13, textDecoration: 'none', display: 'flex', alignItems: 'center', gap: 4, transition: 'color 0.2s' }}
            onMouseEnter={e => e.currentTarget.style.color = colors.text}
            onMouseLeave={e => e.currentTarget.style.color = colors.muted}
          >
